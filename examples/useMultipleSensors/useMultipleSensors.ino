...
#define CS_PIN_SENSOR_2   9   //!< This is also a setup for the Sensor2Go kit but with a second sensor attached
...
Tle5012Ino sensor[SENSOR_NUM] = {
  Tle5012Ino(CS_PIN_SENSOR_1,sensor[0].TLE5012B_S0),
  Tle5012Ino(CS_PIN_SENSOR_2,sensor[1].TLE5012B_S1),
//  (Tle5012Ino(CS_PIN_SENSOR_3,sensor[2].TLE5012B_S2)),
//  (Tle5012Ino(CS_PIN_SENSOR_4,sensor[3].TLE5012B_S3)),
};
